      ...
      <div class="card-body text-center p-0">
              ...
              @if (Session::get('user_role') == 'ADMIN')
                  <div class="p-4 pb-0">
                    ...
                    {{-- <button class="btn btn-primary btn-block text-nowrap" id="createProjectBtn" data-toggle="modal" data-target="#project_form" onclick="openProjectForm()"><i class="fe fe-plus me-1"></i> Create New Project</button> --}}
                </div>
          ...
          <div class="d-flex">
              <div class="d-flex">
                  <div class="d-flex row align-items-center cursor" style="cursor: pointer;" onclick="filterElements('active')">
                      <h6 class="mt-2"><i class="fe fe-circle text-success fs-12"></i> Progress</h6>
              ...
              <div class="d-flex row align-items-center cursor" style="cursor: pointer;" onclick="filterElements('closed')">
                  <h6 class="mt-2"><i class="fe fe-circle text-danger fs-12"></i> Closed</h6>
