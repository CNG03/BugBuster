...
<div class="content-table ">
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item">
          <a class="nav-link active" id="alltickets-tab" data-toggle="tab" href="#alltickets" role="tab" aria-controls="alltickets" aria-selected="true">All Tickets</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" id="ticketscreated-tab" data-toggle="tab" href="#ticketscreated" role="tab" aria-controls="ticketscreated" aria-selected="false">Tickets Created</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" id="assignedtickets-tab" data-toggle="tab" href="#assignedtickets" role="tab" aria-controls="assignedtickets" aria-selected="false">Assigned Tickets</a>
        </li>
      </ul>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="ticket-tab" data-bs-toggle="tab" href="#ticket" role="tab" aria-controls="ticket" aria-selected="true">Ticket</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="team-tab" data-bs-toggle="tab" href="#team" role="tab" aria-controls="team" aria-selected="false">Assigning to</a>
                        </li>
                    </ul>
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="ticket" role="tabpanel" aria-labelledby="ticket-tab">
                            <form>
                                <div class="form-group mt-3">
                                    ...
                                    <input type="text" class="form-control" id="ticketName" placeholder="Enter the name of the ticket">
                                </div>
                                <div class="label-new-ticket" class="form-group">
                                    <label for="estimatedHours">Estimated hours:</label>
                                    <input type="number" class="form-control" id="estimatedHours" min="1" placeholder="4">
                                </div>
                                <div class="form-group">
                                    <label class="label-new-ticket" for="ticketDescription">Description:</label>
                                    <textarea class="form-control" id="ticketDescription" rows="3" placeholder="User should receive a notification when an action related to them occurs in the application."></textarea>
                                </div>
                                <div class="form-group">
                                    <label class="label-new-ticket" for="ticketSTR">Steps to reproduce:</label>
                                    <textarea class="form-control" id="ticketSTR" rows="3" placeholder="User should receive a notification when an action related to them occurs in the application."></textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="ticketER" rows="3" placeholder="User should receive a notification when an action related to them occurs in the application."></textarea>
                                </div>
                                <div class="form-group">
                                    <label class="label-new-ticket" for="ticketAR">Actual Result :</label>
                                    <textarea class="form-control" id="ticketAR" rows="3" placeholder="User should receive a notification when an action related to them occurs in the application."></textarea>
                                </div>
                                <div class="form-group">
