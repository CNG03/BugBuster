        ...
        <div class="offcanvas-body p-0">
            <div class="tabs-menu">
                ...
                <ul class="nav panel-tabs" role="tablist">
                    <li class=""><a href="#tab" class="active show" data-bs-toggle="tab" aria-selected="true"
                            role="tab">Profile</a></li>
                    <li class=""><a href="#tab1" data-bs-toggle="tab" class="" aria-selected="false"
                            tabindex="-1" role="tab">Friends</a></li>
                    <li><a href="#tab2" data-bs-toggle="tab" class="" aria-selected="false" tabindex="-1"
                            role="tab">Activity</a></li>
                    <li><a href="#tab3" data-bs-toggle="tab" class="" aria-selected="false" tabindex="-1"
                            role="tab">Todo</a></li>
                </ul>
            </div>
                ...
                <div class="tab-content">
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="card-body p-3">
                                ...
                                <div class="choices" data-type="select-one" tabindex="0" role="listbox"
                                    ...
                                    <div class="choices__inner">
                                        <select class="form-control choices__input" data-trigger=""
                                            name="choices-single-default" id="choices-single-default2" hidden=""
                                            tabindex="-1" data-choice="active">
                                    ...
                                    <div class="choices__list choices__list--dropdown" aria-expanded="false">
                                        <div class="choices__list" role="listbox">
                                            <div id="choices--choices-single-default2-item-choice-1"
                                                ...
                                                role="option" data-choice="" data-id="1" data-value="Choice 1"
                                                data-select-text="Press to select" data-choice-selectable=""
                                                aria-selected="true">
                                                Spruko.com
                                            </div>
                                            ...
                                            <div id="choices--choices-single-default2-item-choice-4"
                                                class="choices__item choices__item--choice choices__item--selectable"
                                                role="option" data-choice="" data-id="4" data-value="Choice 5"
                                                data-select-text="Press to select" data-choice-selectable="">
                                                sprukotech.com
                                            </div>
                                            <div id="choices--choices-single-default2-item-choice-5"
                                                class="choices__item choices__item--choice choices__item--selectable"
                                                role="option" data-choice="" data-id="5" data-value="Choice 3"
                                                data-select-text="Press to select" data-choice-selectable="">
                            ...
                            <a class="dropdown-item border-top" href="profile.html"> <i
                                    class="dropdown-icon fe fe-edit me-2 float-start"></i> Edit Profile </a>
                            <a class="dropdown-item border-top" href="about.html"> <i
                                    class="dropdown-icon fe fe-user me-2 float-start"></i> Spruko technologies </a>
                            <a class="dropdown-item border-top" href="settings.html"> <i
                                    class="dropdown-icon fe fe-unlock me-2 float-start"></i> Add Another Account </a>
                            <a class="dropdown-item border-top" href="chat.html"> <i
                                    class="dropdown-icon fe fe-mail me-2 float-start"></i> Message </a>
                            <a class="dropdown-item border-top" href="faq.html"> <i
                                    class="dropdown-icon fe fe-help-circle me-2 float-start"></i> Need Help? </a>
                            ...
                            <div class="card-body border-top border-bottom p-3 mt-5">
                                <div class="row">
                                    <div class="col-4 text-center">
                                        <a class="" href="mail.html"><i
                                                class="dropdown-icon mdi mdi-message-outline fs-20 m-0 leading-tight text-primary"></i></a>
                                        <div>Inbox</div>
                                    </div>
                                    <div class="col-4 text-center">
                                        <a class="" href="settings.html"><i
                                                class="dropdown-icon mdi mdi-tune fs-20 m-0 leading-tight text-primary"></i></a>
                                        <div>Settings</div>
                                    </div>
                                    <div class="col-4 text-center">
                                        <a class="" href="{{ route('logout') }}"
                                            ...
                                            <i
                                                class="dropdown-icon mdi mdi-logout-variant fs-20 m-0 leading-tight text-primary"></i>
                                        </a>
                                        <div>Sign out</div>
                                    </div>
                    ...
                    <div class="tab-pane" id="tab3" role="tabpanel">
                        <div class="mt-3">
                            ...
                            <div class="text-center pt-5"><a href="javascript:void(0);" class="btn btn-primary">Add
                                    more</a></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="main-header-container container-fluid">
                        ...
                        <div class="horizontal-logo">
                            <a href="index.html" class="header-logo">
                                <img src="../assets/images/brand-logos/desktop-logo.png" alt="logo"
                                    class="desktop-logo" /> <img src="../assets/images/brand-logos/toggle-logo.png"
                                ...
                                <img src="../assets/images/brand-logos/desktop-white.png" alt="logo"
                                    class="desktop-white" /> <img src="../assets/images/brand-logos/toggle-white.png"
                ...
                <div class="header-content-right">
                    ...
                    <div class="header-element cart-dropdown">
                        ...
                        <a href="javascript:void(0);" class="header-link dropdown-toggle"
                            data-bs-auto-close="outside" data-bs-toggle="dropdown">
                            <i class="fa fa-shopping-cart header-link-icon"></i> <span
                                                ...
                                                <div class="simplebar-content" style="padding: 0px;">
                                                    <li class="dropdown-item">
                                                        <div class="d-flex align-items-start cart-dropdown-item">
                                                            <img src="../assets/images/ecommerce/cart/1.jpg"
                                                                alt="img"
                                                                class="avatar avatar-md rounded-3 me-3" />
                                                            <div class="flex-grow-1">
                                                                <div
                                                                    class="d-flex align-items-start justify-content-between mb-0">
                                                                    <div class="mb-0 fs-14 text-dark fw-semibold"><a
                                                                            href="product-cart.html">Wall Photo
                                                                            Frame</a></div>
                                                                    <div>
                                                    ...
                                                    <li class="dropdown-item">
                                                        <div class="d-flex align-items-start cart-dropdown-item">
                                                            <img src="../assets/images/ecommerce/cart/3.jpg"
                                                                alt="img"
                                                                class="avatar avatar-md rounded-3 me-3" />
                                                            <div class="flex-grow-1">
                                                                <div
                                                                    class="d-flex align-items-start justify-content-between mb-0">
                                                                    <div class="mb-0 fs-14 text-dark fw-semibold"><a
                                                                            href="product-cart.html">Designed Chair</a>
                                                                    </div>
                                                                    <div>
                                                                        <a href="javascript:void(0);"
                                                                            class="header-cart-remove float-end dropdown-item-close"><i
                                                    ...
                                                    <li class="dropdown-item">
                                                        <div class="d-flex align-items-start cart-dropdown-item">
                                                            <img src="../assets/images/ecommerce/cart/5.jpg"
                                                                alt="img"
                                                                class="avatar avatar-md rounded-3 me-3" />
                                                            <div class="flex-grow-1">
                                                                <div
                                                    ...
                                                    <li class="dropdown-item">
                                                        <div class="d-flex align-items-start cart-dropdown-item">
                                                            <img src="../assets/images/ecommerce/cart/4.jpg"
                                                                alt="img"
                                                                class="avatar avatar-md rounded-3 me-3" />
                                                            <div class="flex-grow-1">
                                                                <div
                                                                    class="d-flex align-items-start justify-content-between mb-0">
                                                                    <div class="mb-0 fs-14 text-dark fw-semibold"><a
                                                                            href="product-cart.html">Ultra Camera
                                                                            Lens</a></div>
                                                                    <div>
                                                                        <a href="javascript:void(0);"
                                                                            class="header-cart-remove float-end dropdown-item-close"><i
                                                    ...
                                                    <li class="dropdown-item">
                                                        <div class="d-flex align-items-start cart-dropdown-item">
                                                            <img src="../assets/images/ecommerce/cart/6.jpg"
                                                                alt="img"
                                                                class="avatar avatar-md rounded-3 me-3" />
                                                            <div class="flex-grow-1">
                                                                <div
                                                                    class="d-flex align-items-start justify-content-between mb-0">
                                                                    <div class="mb-0 fs-14 text-dark fw-semibold"><a
                                                                            href="product-cart.html">Stylish Coffee
                                                                            Cup</a></div>
                                                                    <div>
                                                                        <a href="javascript:void(0);"
                                                                            class="header-cart-remove float-end dropdown-item-close"><i
                        ...
                        <div class="main-header-dropdown dropdown-menu pt-0 border-0 header-profile-dropdown dropdown-menu-end dropdown-menu-arrow"
                            ...
                            <div>
                                <a class="dropdown-item" href="profile.html"><i class="fa fa-user me-1"></i> My
                                    Profile</a> <a class="dropdown-item" href="profile.html"><i
                                        class="fa fa-edit me-1"></i> Edit Profile</a>
                                <a class="dropdown-item" href="notifications.html"><i
                                        class="fa fa-clock me-1"></i> Activity Logs</a> <a class="dropdown-item"
                                    href="settings.html"><i class="fa fa-sliders-h me-1"></i> Account Settings</a>
                                <a class="dropdown-item"
                                    onclick="event.preventDefault(); document.getElementById('logout-form').submit();"
                                    href="{{ route('logout') }}"><i class="fa fa-sign-out-alt me-1"></i> Sign
                                    Out</a>
                                <form id="logout-form" action="{{ route('logout') }}" method="POST"
                                    style="display: none;">
                                    @csrf
                                ...
                                <div class="simplebar-content" style="padding: 8px 0px 80px;">
                                    ...
                                    <nav class="main-menu-container nav nav-pills flex-column sub-open active">
                                        ...
                                        <ul class="main-menu active" style="margin-left: 0px; margin-right: 0px;">
                                            ...
                                            <!-- End::slide -->
                                            <!-- Start::slide__category -->
                                            <li class="slide__category"><span class="category-name">widgets &amp;
                                                    maps</span></li>
                                            <!-- End::slide__category -->
                                            <!-- Start::slide -->
                                            <li class="slide">
                                                <a href="" class="side-menu__item"> <i
                                                        class="side-menu__icon fa-solid fa-cube"></i> <span
                                            ...
                                            <li class="slide has-sub ">
                                                <a href="javascript:void(0);" class="side-menu__item">
                                                    <i class="side-menu__icon fa-solid fa-briefcase"></i> <span
                                                        class="side-menu__label">Apps</span> <i
                                                        class="fa-solid fa-chevron-right side-menu__angle"></i>
                                                </a>
                                                <ul class="slide-menu child1"
                                                    style="position: relative; left: 0px; top: 0px; margin: 0px; transform: translate(120px, 300px);"
                                                    ...
                                                    <li class="slide has-sub">
                                                        ...
                                                        <ul class="slide-menu child2">
                                                            <li class="slide"><a href="filemanager.html"
                                                            ...
                                                            <li class="slide"><a href="filemanager-details.html"
                                            ...
                                            <!-- Start::slide -->
                                            <li class="slide">
                                                <a href="icons.html" class="side-menu__item"> <i
                                                        class="side-menu__icon fa-regular fa-face-smile menu-icon"></i>
                                            ...
                                            <li class="slide has-sub">
                                                <a href="javascript:void(0);" class="side-menu__item">
                                                    <i class="side-menu__icon fa-solid fa-map menu-icon"></i> <span
                                                        class="side-menu__label">Maps</span> <i
                                                        class="fa-solid fa-chevron-right side-menu__angle"></i>
                                                </a>
                                                <ul class="slide-menu child1"
                                                    style="position: relative; left: 0px; top: 0px; margin: 0px; transform: translate(120px, 392px);"
                                                    data-popper-placement="bottom">
                                                    <li class="slide side-menu__label1"><a
                                            ...
                                            <li class="slide__category"><span
                                                    class="category-name">componenents</span></li>
                                            <!-- End::slide__category -->
                                            <!-- Start::slide -->
                                            <li class="slide has-sub">
                                                <a href="javascript:void(0);" class="side-menu__item">
                                                    <i class="side-menu__icon fa-solid fa-server"></i> <span
                                                        class="side-menu__label">Elements</span> <i
                                                        class="fa fa-chevron-right side-menu__angle"></i>
                                                </a>
                                                <ul class="slide-menu child1 mega-menu"
                                                    style="position: relative; left: 0px; top: 0px; margin: 0px; transform: translate(120px, 488px);"
                                                    data-popper-placement="bottom">
                                                    <li class="slide side-menu__label1"><a
                                            ...
                                            <li class="slide has-sub">
                                                ...
                                                <ul class="slide-menu child1"
                                                    style="position: relative; left: 0px; top: 0px; margin: 0px; transform: translate(120px, 534px);"
                                                    data-popper-placement="bottom">
                                                    <li class="slide side-menu__label1"><a
                                            ...
                                            <!-- End::slide -->
                                            <!-- Start::slide__category -->
                                            <li class="slide__category"><span class="category-name">Forms</span>
                                            </li>
                                            <!-- End::slide__category -->
                                            <!-- Start::slide -->
                                            <li class="slide has-sub">
                                            ...
                                            <li class="slide has-sub">
                                                <a href="javascript:void(0);" class="side-menu__item">
                                                    <i class="side-menu__icon ti-view-grid"></i> <span
                                                        class="side-menu__label">Sub Menus</span> <i
                                                        class="fe fe-chevron-right side-menu__angle"></i>
                                                </a>
                                                <ul class="slide-menu child1"
                                                    style="position: relative; left: 0px; top: 0px; margin: 0px; transform: translate(120px, 676px);"
                                                    data-popper-placement="bottom">
                                                    <li class="slide side-menu__label1"><a
                                                            href="javascript:void(0)">Sub Menus</a></li>
                                            ...
                                            <!-- End::slide -->
                                            <!-- Start::slide__category -->
                                            <li class="slide__category"><span class="category-name">other
                                                    pages</span></li>
                                            <!-- End::slide__category -->
                                            <!-- Start::slide -->
                                            <li class="slide has-sub">
                                                <a href="javascript:void(0);" class="side-menu__item">
                                                    <i class="side-menu__icon ti-files"></i> <span
                                                        class="side-menu__label">Pages</span> <i
                                                        class="fe fe-chevron-right side-menu__angle"></i>
                                                </a>
                                                <ul class="slide-menu child1"
                                                    style="position: relative; left: 0px; top: 0px; margin: 0px; transform: translate(120px, 772px);"
                                                    data-popper-placement="bottom">
                                                    <li class="slide side-menu__label1"><a
                                                    ...
                                                    <li class="slide"><a href="services.html"
                                                            class="side-menu__item">Services</a></li>
                                                    <li class="slide"><a href="terms.html"
                                                            class="side-menu__item">Terms</a></li>
                                                    <li class="slide"><a href="about.html"
                                                            class="side-menu__item">About Company</a></li>
                                                    ...
                                                    <li class="slide has-sub">
                                                        <a href="javascript:void(0);" class="side-menu__item">Custom
                                                            Pages <i
                                                                class="fe fe-chevron-right side-menu__angle"></i></a>
                                                        <ul class="slide-menu child2">
                                            ...
                                            <li class="slide has-sub">
                                                <a href="javascript:void(0);" class="side-menu__item">
                                                    <i class="side-menu__icon ti-layers-alt"></i> <span
                                                        class="side-menu__label">Utilities</span> <i
                                                        class="fe fe-chevron-right side-menu__angle"></i>
                                                </a>
                                                <ul class="slide-menu child1"
                                                    style="position: relative; left: 0px; top: 0px; margin: 0px; transform: translate(120px, 818px);"
                                                    data-popper-placement="bottom">
                                                    <li class="slide side-menu__label1"><a
                                            ...
                                            <li class="slide has-sub">
                                                <a href="javascript:void(0);" class="side-menu__item">
                                                    <i class="side-menu__icon ti-bar-chart-alt"></i> <span
                                                        class="side-menu__label">Charts</span> <i
                                                        class="fe fe-chevron-right side-menu__angle"></i>
                                                </a>
                                                <ul class="slide-menu child1"
                                                    style="position: relative; left: 0px; top: 0px; margin: 0px; transform: translate(120px, 914px);"
                                                    data-popper-placement="bottom">
                                                    <li class="slide side-menu__label1"><a
                                            ...
                                            <li class="slide has-sub">
                                                <a href="javascript:void(0);" class="side-menu__item">
                                                    <i class="side-menu__icon ti-layout-grid3"></i> <span
                                                        class="side-menu__label">Tables<span
                                                            class="badge bg-success-transparent ms-2">3</span></span>
                                                    <i class="fe fe-chevron-right side-menu__angle"></i>
                                                </a>
                                                <ul class="slide-menu child1"
                                                    style="position: relative; left: 0px; top: 0px; margin: 0px; transform: translate(120px, 962px);"
                                                    data-popper-placement="bottom">
                                                    <li class="slide side-menu__label1"><a
        ...
        <footer class="footer mt-auto py-3 bg-white text-center">
            <div class="container">
                <span class="text-muted">
                    Copyright © <span id="year">2024</span> <a href="javascript:void(0);"
                        class="text-primary fw-semibold">Xino</a>. Designed with <span
