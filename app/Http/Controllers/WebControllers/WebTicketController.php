...
class WebTicketController extends Controller
{
    public function allTickets(Request $request, $projectID)
    {
        ...
        ])->get('https://bugbuster.click/api/v1/project/tickets/' . $projectID, [
    ...
    public function createdTickets(Request $request, $projectID)
    {
        ...
        $response = Http::withHeaders([
            'Authorization' => 'Bearer ' . Session::get('accessToken'),
        ])->get('https://bugbuster.click/api/v1/tickets/created/' . $projectID, [
            'page' => $request->input('page', 1)
        ]);
        ...
        $response4 = Http::withHeaders([
            'Authorization' => 'Bearer ' . Session::get('accessToken'),
        ])->get('https://bugbuster.click/api/v1/projectmembers/' . $projectID);
    ...
    public function createTicket(Request $request)
    {
        ...
        )->post('https://bugbuster.click/api/v1/tickets', $payload);
    ...
    public function updateStatus(Request $request)
    {
        ...
        $apiUrl = "https://bugbuster.click/api/v1/tickets/status/" . $request->input('ticket_id');
    ...
    public function assignedTickets(Request $request, $projectID)
    {
        ...
        $response = Http::withHeaders([
            'Authorization' => 'Bearer ' . Session::get('accessToken'),
        ])->get('https://bugbuster.click/api/v1/tickets/assigned/' . $projectID, [
            'page' => $request->input('page', 1)
        ]);
    ...
    public function ticketDetail($ticketId)
    {
        ...
        ])->get('https://bugbuster.click/api/v1/tickets/' . $ticketId);
    ...
    public function updateTicket(Request $request, $ticketID)
    {
        ...
        $response = Http::withHeaders([
            ...
            file_get_contents($request->file('illustration')->getRealPath()),
            $request->file('illustration')->getClientOriginalName()
        )->post('https://bugbuster.click/api/v1/tickets/' . $ticketID, $payload);
